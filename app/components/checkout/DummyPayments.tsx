  ...
  return (
    <div className="flex flex-col items-center">
        ...
        <div className="rounded-md bg-gray-50 p-4 mb-8">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-gray-700">{paymentError}</div>
            </div>
          </div>
        </div>
      )}
      <Form method="post">
        ...
        <button
          type="submit"
          className="flex px-6 bg-gray-600 hover:bg-gray-700 items-center justify-center space-x-2 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
        >
